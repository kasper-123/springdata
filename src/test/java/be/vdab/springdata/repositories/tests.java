...
import be.vdab.springdata.repositories.FiliaalRepository;
import be.vdab.springdata.repositories.WerknemerRepository;
...
class tests extends AbstractTransactionalJUnit4SpringContextTests {
    private final WerknemerRepository repository;
    private final FiliaalRepository filiaalRepository;

    tests(WerknemerRepository repository, FiliaalRepository filiaalRepository) {
